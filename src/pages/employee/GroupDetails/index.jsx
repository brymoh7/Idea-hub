...
const GroupsPage = () => {
    ...
    return (
        <Layout activeTab={activeTab} setActiveTab={setActiveTab} className=''>
                        ...
                        <div className="bg-white mb-6 rounded border border-white shadow p-4" key={idea?.campaignId}>
                            <div className="flex items-center justify-between text-[#7F7F7F]">
                                <div className="flex items-center">
                                    <p className="w-[64px] h-[64px] bg-[#BB80F7] rounded-full flex items-center justify-center text-white font-semibold text-2xl">
                                        KP
                                    </p>
                                    <div className="px-3 flex flex-col">
                                        <p className="text-[#111111] font-semibold">
                                            {idea?.title ?? '#KeyPerformancePosts'}
                                        </p>
